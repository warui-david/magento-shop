...
class Interceptor extends \Magento\Wishlist\Model\ResourceModel\Item\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addWishlistFilter(\Magento\Wishlist\Model\Wishlist $wishlist)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addWishlistFilter', func_get_args(), $pluginInfo) : parent::addWishlistFilter($wishlist);
    }
    ...
    public function addCustomerIdFilter($customerId)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addCustomerIdFilter', func_get_args(), $pluginInfo) : parent::addCustomerIdFilter($customerId);
    }
    ...
    public function resetSortOrder()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('resetSortOrder', func_get_args(), $pluginInfo) : parent::resetSortOrder();
    }
    ...
    public function setVisibilityFilter($flag = true)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setVisibilityFilter', func_get_args(), $pluginInfo) : parent::setVisibilityFilter($flag);
    }
    ...
    public function setSalableFilter($flag = true)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setSalableFilter', func_get_args(), $pluginInfo) : parent::setSalableFilter($flag);
    }
    ...
    public function setInStockFilter($flag = true)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setInStockFilter', func_get_args(), $pluginInfo) : parent::setInStockFilter($flag);
    }
    ...
    public function addDaysInWishlist()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addDaysInWishlist', func_get_args(), $pluginInfo) : parent::addDaysInWishlist();
    }
    ...
    public function addDaysFilter($constraints)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addDaysFilter', func_get_args(), $pluginInfo) : parent::addDaysFilter($constraints);
    }
    ...
    public function addProductNameFilter($productName)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addProductNameFilter', func_get_args(), $pluginInfo) : parent::addProductNameFilter($productName);
    }
    ...
    public function setOrderByProductName($dir)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('setOrderByProductName', func_get_args(), $pluginInfo) : parent::setOrderByProductName($dir);
    }
